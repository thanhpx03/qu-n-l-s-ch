...
Route::get('/view',[BookControllerClient::class,'viewCart'] )->name('cart.view');
Route::post('/add/{id}', [BookControllerClient::class,'addToCart'] )->name('cart.add');
...
Route::middleware(['auth'])->group(function () {
    ...
    //thanh toán
    Route::match(['GET', 'POST'], '/thanh-toan/{id}', [BookingController::class, 'index'])->name('thanh-toan');
