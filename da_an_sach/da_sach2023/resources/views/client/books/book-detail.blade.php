    ...
    <div class="container">
        <div class="details-banner-wrapper">
            <div class="details-banner-thumb">
                <img alt="movies" width="60" src="{{ asset($book->poster)  }}" alt="Image">
            ...
            <div class="details-banner-content offset-lg-3">
                ...
                <div class="tags">
                    <a href="#0">{{$book->language}}</a>
                    <a href="#0">Việt Nam</a>
                </div>
                <div class="social-and-duration">
                    <div class="duration-area">
                        <div class="item">
                            <span>Số lượng :</span><span>{{$book->quantily}}</span>
                        </div>
                        <div class="item">
                          <span>giá :</span><span>{{$book->price}} </span>
                        </div>
                        <div class="item">
...
<section class="book-section bg-one">
    <div class="container">
        ...
        <a href="{{ route('cart.add',['id'=>$book->id]) }}" class="custom-button">thêm vào giỏi hàng</a>
